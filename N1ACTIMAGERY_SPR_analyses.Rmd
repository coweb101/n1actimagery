---
title: "N1ACTIMAGERY_SPR_analyses"
...
#### Create plot (matching colours of grand average plot) ####
...
#### Create plot (matching colours of grand average plot) WITHOUT CUE ####
...
# define colors
point_colors <- c(3:5,7)

# open PNG
png(filename = "plots/N1_condition_effect_color_without_cue.png", width = 5.5, height = 4, units = "in", res = 400)
par(mgp=c(1.95,.65,0.65)) 

plot(1:4, plotdata$predicted,  
     type = "p", col = point_colors, pch = 16, xlab = "", ylab = expression("Predicted N1 amplitudes in "* mu*V),
     ylim = c(-2,-6), yaxt = "n", xaxt = "n", main = "", bty = "n")
...
#### Create plot to visualize differences in attenuation magnitude (quick and dirty)
sjPlot::plot_model(n1_model, vline.color = 7, show.values = TRUE,
                 axis.labels=rev(c("Execution", "Imagery", "Observation", "Cued Sound")))
```
...
#### Create P2 Plot without cue condition ####
...
# open png
png(filename = "plots/P2_condition_effect_color_without_cue.png", width = 5.5, height = 4, units = "in", res = 400)
par(mgp=c(1.95,.65,0.65))
